const DefaultWubooWithHalo = (props: React.SVGProps<SVGSVGElement>) => {
  return (
    <svg
      width={240}
      height={240}
      viewBox="55 10 130 215"
    ...
    >
      ...
      <g
        style={{
          ...
          animation: "bobHalo 4s linear infinite",
        }}
      >
        <ellipse
          cx={120}
      ...
      <g className="bot-halo-wuboo">
        <g className="head-group-halo-wuboo">
          <path
...
export default DefaultWubooWithHalo;
